...
let s:dark_red        = { "gui": "#FB4934", "cterm": "1"   }
...
if &background == "dark"
  ...
  let s:visual          = s:light_cyan
  let s:yellow          = s:light_yellow
  let s:cursor_bg       = s:actual_white
  let s:cursor_fg       = s:black
else
  ...
  let s:cursor_bg       = s:black
  let s:cursor_fg       = s:actual_white
endif
...
call s:h("Comment",       {"fg": s:dark_red, "gui": "NONE"})
...
call s:h("Operator",      {"fg": s:norm_subtle, "cterm": "NONE", "gui": "NONE"})
...
call s:h("CursorLineNr",  {"fg": s:black, "bg": s:light_green})
